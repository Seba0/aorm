...
public final class TableHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_AORM_TABLE = "CREATE TABLE " + TableUtils.AORM_TABLE + "(NAME TEXT UNIQUE PRIMARY KEY NOT NULL, VERSION INTEGER NOT NULL DEFAULT 0)";
    public static final int VERSION = 1;
    public static final String NAME = "aorm";
